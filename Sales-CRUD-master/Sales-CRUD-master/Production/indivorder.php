	...
	function new_order_indiv($db, $customerList, $custType) { ?>
		...
		<form action="submitOrder.php" id="newOrderForm" method="post">
	  		...
	  		<div class="form-group">
	    		...
	    		<select class="form-control" id="ProductSelection" onchange="dynamicProdForm()" name="productType" required="true">
	  		...
	  		<div class="form-group row">
			  	...
			  	<div class="col-10">
			    	<input class="form-control" type="date" value="yyyy-MM-dd" name="orderDate" required="true">
				</div>
			</div>
	  		<div class="form-group row">
			  	<label for="example-date-input" class="col-2 col-form-label">Due Date</label>
			  	<div class="col-10">
			    	<input class="form-control" type="date" value="yyyy-MM-dd" name="dueDate" required="true">
				</div>
			</div>
		  		<div class="form-group">
	  		...
	  		<div id="productDetails">
				<div class="form-group row">
				  ...
				  <div class="col-10">
				    <input class="form-control" type="number" step="0.01" id="inp-len" value="0" name="length" required="true">
				  </div>
				</div>
				<div class="form-group row">
				  <label for="example-number-input" class="col-2 col-form-label">Thickness(mm)</label>
				  <div class="col-10">
				    <input class="form-control" type="number" step="0.01" id="inp-thick" value="0" name="thick" required="true">
				  </div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
				  ...
				  <div class="col-10">
				    <input class="form-control" type="number" value="0" name="quan" id="inp-quan" required="true">
				  </div>
				</div>
